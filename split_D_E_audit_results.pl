...
"BRANDON_MANITOBA" => "Manatoba/Saskatchewan",
"CHURCHILL_MANITOBA" => "Manatoba/Saskatchewan",
"DAUPHIN_MANITOBA" => "Manatoba/Saskatchewan",
"PORTAGE^LA^PRAIRIE_MANITOBA" => "Manatoba/Saskatchewan",
"THE^PAS_MANITOBA" => "Manatoba/Saskatchewan",
"THOMPSON_MANITOBA" => "Manatoba/Saskatchewan",
"WINNIPEG_MANITOBA" => "Manatoba/Saskatchewan",
...
"BROADVIEW_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"ESTEVAN_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"MOOSE^JAW_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"NORTH^BATTLEFORD_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"PRINCE^ALBERT_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"REGINA_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"SASKATOON_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"SWIFT^CURRENT_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"URANIUM^CITY_SASKATCHEWAN" => "Manatoba/Saskatchewan",
"YORKTON_SASKATCHEWAN" => "Manatoba/Saskatchewan",
...
while ( my $line = <FILEIN1> ){ 
  ...
  if ($line_no == 0) {
    ...
    foreach my $column (@columns) {
     ...
     if ( $column =~ /WEATHERLOC/ ) { push @keep_col_index, $colindex-1;
                                      $weatherloc_index = $colindex  - 1  ; }
     if ( $column =~ /YEARBUILT/ ) { push @keep_col_index, $colindex-1;
                                     $yearbuilt_index = $colindex  - 1  ; }
  ...
  foreach my $column (@keep_col_index){
    ...
    if ( @keep_col_index > -1  ){
      #print " OUT: $column | ".$columns[$column]." \n"; 
  ...
  if ( $columns[$eval_col_index] =~ /EVAL_TYP/ ) { $output .= "SHEU-region,SHEU-vintage,HDD,936-bsm-RSI,936-wall-RSI,936-attic-RSI,junk\n"; 
    ...
    $output .= "$SHEU_region,$SHEU_vintage,$HDD,$bsmRSI,$wallRSI,$attRSI,NA\n"; 
