...
This script parses the full EGH database for only those columns of interest for the particular project.
It reads in the full EGH database "evaluations_d_e.csv" and writes the parsed data to a text file.

2. Perl-split_D_E_audit_results.pl
This script reads in the output file from Perl-parse-script.pl and writes out two text files.
